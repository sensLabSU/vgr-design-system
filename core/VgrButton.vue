...
const colors = {
  healthcare: {
    ...
    outline: 'text-healthcare-40 border-healthcare-40 hover:bg-healthcare-40/10 focus-visible:bg-healthcare-40/10 active:bg-healthcare-40/30 dark:border-healthcare-60 dark:text-healthcare-60',
  },
  culture: {
    ...
    outline: 'text-culture-40 border-culture-40 hover:bg-culture-40/10 focus-visible:bg-culture-40/10 active:bg-culture/30 dark:border-healthcare-60 dark:text-healthcare-60',
  },
  education: {
    ...
    outline: 'text-education-40 border-education-40 hover:bg-education-40/10 focus-visible:bg-education-40/10 active:bg-education/30 dark:border-education-60 dark:text-education-60',
  },
  base: {
    ...
    outline: 'text-base-30 border-base-30 hover:bg-base-30/10 focus-visible:bg-base-30/10 active:bg-base/30 dark:border-base-60 dark:text-base-60',
  },
  neutral: {
    ...
    outline: 'text-neutral-40 border-neutral-40 hover:bg-neutral-40/10 focus-visible:bg-neutral-40/10 active:bg-neutral-40/30 dark:border-neutral-60 dark:text-neutral-60',
  },
  error: {
    ...
    outline: 'text-error-40 border-error-40 hover:bg-error-40/10 focus-visible:bg-error-40/10 active:bg-error-40/30 dark:border-error-60 dark:text-error-60',
  },
  purple: {
    ...
    outline: 'text-purple-50 border-purple-50 hover:bg-purple-50/10 focus-visible:bg-purple-50/10 active:bg-purple-50/30 dark:border-purple-60 dark:text-purple-60',
  },
  brown: {
    ...
    outline: 'text-brown-50 border-brown-50 hover:bg-brown-50/10 focus-visible:bg-brown-50/10 active:bg-brown-50/30 dark:border-brown-60 dark:text-brown-60',
  },
  cyan: {
    ...
    outline: 'text-cyan-50 border-cyan-50 hover:bg-cyan-50/10 focus-visible:bg-cyan-50/10 active:bg-cyan-50/30 dark:border-cyan-60 dark:text-cyan-60',
  },
  green: {
    ...
    outline: 'text-green-50 border-green-50 hover:bg-green-50/10 focus-visible:bg-green-50/10 active:bg-green-50/30 dark:border-green-60 dark:text-green-60',
  },
  lime: {
    ...
    outline: 'text-lime-50 border-lime-50 hover:bg-lime-50/10 focus-visible:bg-lime-50/10 active:bg-lime-50/30 dark:border-lime-60 dark:text-lime-60',
  },
  orange: {
    ...
    outline: 'text-orange-50 border-orange-50 hover:bg-orange-50/10 focus-visible:bg-orange-50/10 active:bg-orange-50/30 dark:border-orange-60 dark:text-orange-60',
  },
  pink: {
    ...
    outline: 'text-pink-50 border-pink-50 hover:bg-pink-50/10 focus-visible:bg-pink-50/10 active:bg-pink-50/30 dark:border-pink-60 dark:text-pink-60',
  },
  yellow: {
    ...
    outline: 'text-yellow-50 border-yellow-50 hover:bg-yellow-50/10 focus-visible:bg-yellow-50/10 active:bg-yellow-50/30 dark:border-yellow-60 dark:text-yellow-60',
  },
  white: {
  ...
  blue: {
    ...
    outline: 'text-blue-50 border-blue-50 hover:bg-blue-50/10 focus-visible:bg-blue-50/10 active:bg-blue-50/30 dark:border-blue-60 dark:text-blue-60',
  },
  black: {
