...
const colors = {
  healthcare: {
    ...
    ghost: 'text-healthcare-40 border-transparent hover:bg-healthcare-40/10 focus-visible:bg-healthcare-40/10 active:bg-healthcare-40/30',
    outline: 'text-healthcare-40 border-healthcare-40 hover:bg-healthcare-40/10 focus-visible:bg-healthcare-40/10 active:bg-healthcare-40/30',
  },
  culture: {
    ...
    ghost: 'text-culture-40 border-transparent hover:bg-culture-40/10 focus-visible:bg-culture-40/10 active:bg-culture/30',
    outline: 'text-culture-40 border-culture-40 hover:bg-culture-40/10 focus-visible:bg-culture-40/10 active:bg-culture/30',
  },
  education: {
    ...
    ghost: 'text-education-40 border-transparent hover:bg-education-40/10 focus-visible:bg-education-40/10 active:bg-education/30',
    outline: 'text-education-40 border-education-40 hover:bg-education-40/10 focus-visible:bg-education-40/10 active:bg-education/30',
  },
  base: {
    ...
    ghost: 'text-base-30 border-transparent hover:bg-base-30/10 focus-visible:bg-base-30/10 active:bg-base/30',
    outline: 'text-base-30 border-base-30 hover:bg-base-30/10 focus-visible:bg-base-30/10 active:bg-base/30',
  },
  neutral: {
    ...
    ghost: 'text-neutral-40 border-transparent hover:bg-neutral-40/10 focus-visible:bg-neutral-40/10 active:bg-neutral-40/30',
    outline: 'text-neutral-40 border-neutral-40 hover:bg-neutral-40/10 focus-visible:bg-neutral-40/10 active:bg-neutral-40/30',
  },
  error: {
    ...
    ghost: 'text-error-40 border-transparent hover:bg-error-40/10 focus-visible:bg-error-40/10 active:bg-error-40/30',
    outline: 'text-error-40 border-error-40 hover:bg-error-40/10 focus-visible:bg-error-40/10 active:bg-error-40/30',
  },
  purple: {
    ...
    ghost: 'text-purple-50 border-transparent hover:bg-purple-50/10 focus-visible:bg-purple-50/10 active:bg-purple-50/30',
    outline: 'text-purple-50 border-purple-50 hover:bg-purple-50/10 focus-visible:bg-purple-50/10 active:bg-purple-50/30',
  },
  brown: {
    ...
    ghost: 'text-brown-50 border-transparent hover:bg-brown-50/10 focus-visible:bg-brown-50/10 active:bg-brown-50/30',
    outline: 'text-brown-50 border-brown-50 hover:bg-brown-50/10 focus-visible:bg-brown-50/10 active:bg-brown-50/30',
  },
  cyan: {
    ...
    ghost: 'text-cyan-50 border-transparent hover:bg-cyan-50/10 focus-visible:bg-cyan-50/10 active:bg-cyan-50/30',
    outline: 'text-cyan-50 border-cyan-50 hover:bg-cyan-50/10 focus-visible:bg-cyan-50/10 active:bg-cyan-50/30',
  },
  green: {
    ...
    ghost: 'text-green-50 border-transparent hover:bg-green-50/10 focus-visible:bg-green-50/10 active:bg-green-50/30',
    outline: 'text-green-50 border-green-50 hover:bg-green-50/10 focus-visible:bg-green-50/10 active:bg-green-50/30',
  },
  lime: {
    ...
    ghost: 'text-lime-50 border-transparent hover:bg-lime-50/10 focus-visible:bg-lime-50/10 active:bg-lime-50/30',
    outline: 'text-lime-50 border-lime-50 hover:bg-lime-50/10 focus-visible:bg-lime-50/10 active:bg-lime-50/30',
  },
  orange: {
    ...
    ghost: 'text-orange-50 border-transparent hover:bg-orange-50/10 focus-visible:bg-orange-50/10 active:bg-orange-50/30',
    outline: 'text-orange-50 border-orange-50 hover:bg-orange-50/10 focus-visible:bg-orange-50/10 active:bg-orange-50/30',
  },
  pink: {
    ...
    ghost: 'text-pink-50 border-transparent hover:bg-pink-50/10 focus-visible:bg-pink-50/10 active:bg-pink-50/30',
    outline: 'text-pink-50 border-pink-50 hover:bg-pink-50/10 focus-visible:bg-pink-50/10 active:bg-pink-50/30',
  },
  yellow: {
    ...
    ghost: 'text-yellow-50 border-transparent hover:bg-yellow-50/10 focus-visible:bg-yellow-50/10 active:bg-yellow-50/30',
    outline: 'text-yellow-50 border-yellow-50 hover:bg-yellow-50/10 focus-visible:bg-yellow-50/10 active:bg-yellow-50/30',
  },
  white: {
