...
const cardClasses = computed(() => {
  switch(props.variant) {
    case 'information': return '!bg-blue-99 text-blue-30 !border-blue-80 dark:!bg-blue-20 dark:text-blue-90 dark:!border-blue-40';
    case 'success': return '!bg-green-99 text-green-30 !border-green-80 dark:!bg-green-20 dark:text-green-90 dark:!border-green-40';
    ...
    case 'danger': return '!bg-error-99 text-error-30 !border-error-80 dark:!bg-error-20 dark:text-error-90 dark:!border-error-40';
